...
{
  [SXObjectAttr("CstParametrosObject", "ZPARAMETROS", typeof(Properties.Resources), nameof(Properties.Resources.ParametrosObject))]
  [SXFinderAttr(new[] { nameof(CodColigada), nameof(CodColigadaReport) })]
  public class CstParametrosObject : SXObject
  {
